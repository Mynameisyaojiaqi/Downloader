...
configure_file_dir = "D:/Data/"#配置文件所在目录
user_name = "lgy@aoe.ac.cn"#用户名
password = "lgy@aoe.ac.cn"#密码
login_url = "https://rda.ucar.edu/cgi-bin/login"#登录服务器地址
cookie_save_path = "D:/Data/python/NCAR/cookies/NCAR_Cookies.txt"#cookie存储地址
download_url_prefix = "https://rda.ucar.edu/data/ds083.2/grib2/"#文件所在url
download_file_dir = "D:/Data/python/NCAR/download_files/"#下载到该文件夹下
download_records_dir = "D:/Data/python/NCAR/records/"#下载记录
download_records_new = "D:/Data/python/NCAR/records/waiting_for_download.txt"
error_records = "D:/Data/python/NCAR/records/error.txt"
decompressed_file_dir = "D:/daqidata/"#解压路径
extractTools_Path = "D:/Data/python/NCAR/ExtractTools/"#解压工具路径
bat_path = "D:/Data/python/NCAR/temp_bat/"
